...
void inline fileAppendContent(const std::string& name, const std::string& content) {
    std::ofstream outfile;
    outfile.open(name, std::ios_base::app);
    outfile << content;
}
void inline fileDumpContent(const std::string& name, const std::string& content) {
    std::ofstream outfile;
    outfile.open(name);
    outfile << content;
}
