...
#define HEDLEY_SUNPRO_VERSION                                                  \
  HEDLEY_VERSION_ENCODE((__SUNPRO_C >> 8) & 0xf, (__SUNPRO_C >> 4) & 0xf,      \
                        (__SUNPRO_C)&0xf)
...
#define HEDLEY_SUNPRO_VERSION                                                  \
  HEDLEY_VERSION_ENCODE((__SUNPRO_CC >> 8) & 0xf, (__SUNPRO_CC >> 4) & 0xf,    \
                        (__SUNPRO_CC)&0xf)
#endif
...
#define HEDLEY_PRINTF_FORMAT(string_idx, first_to_check)                       \
  __attribute__((__format__(gnu_printf, string_idx, first_to_check)))
    ...
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) ||                                    \
    HEDLEY_ARM_VERSION_CHECK(5, 6, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || \
    HEDLEY_TI_VERSION_CHECK(8, 0, 0) ||                                        \
    (HEDLEY_TI_VERSION_CHECK(7, 3, 0) &&                                       \
     defined(__TI_GNU_ATTRIBUTE_SUPPORT__))
#define HEDLEY_PRINTF_FORMAT(string_idx, first_to_check)                       \
...
#define HEDLEY_RESTRICT restrict
    ...
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) ||                                    \
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || \
    HEDLEY_PGI_VERSION_CHECK(17, 10, 0) || HEDLEY_TI_VERSION_CHECK(8, 0, 0) || \
