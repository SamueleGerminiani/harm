...
#endif
#define HEDLEY_VERSION_DECODE_MINOR(version)                         \
...
#define HEDLEY_GNUC_VERSION                                          \
  HEDLEY_VERSION_ENCODE(__GNUC__, __GNUC_MINOR__, 0)
#endif
...
#define HEDLEY_INTEL_VERSION                                         \
  HEDLEY_VERSION_ENCODE(__INTEL_COMPILER / 100,                      \
...
#undef HEDLEY_PGI_VERSION
    ...
    defined(__PGIC_MINOR__) && defined(__PGIC_PATCHLEVEL__)
...
#define HEDLEY_IAR_VERSION                                           \
  HEDLEY_VERSION_ENCODE((__VER__ / 1000000),                         \
                        ((__VER__ / 1000) % 1000), (__VER__ % 1000))
#else
#define HEDLEY_IAR_VERSION                                           \
  HEDLEY_VERSION_ENCODE(VER / 100, __VER__ % 100, 0)
#endif
#endif
...
#define HEDLEY_DMC_VERSION                                           \
  HEDLEY_VERSION_ENCODE(__DMC__ >> 8, (__DMC__ >> 4) & 0xf,          \
                        __DMC__ & 0xf)
#endif
...
#endif
#if defined(__has_cpp_attribute) && defined(__cplusplus)
#define HEDLEY_GNUC_HAS_CPP_ATTRIBUTE(attribute, major, minor,       \
                                      patch)                         \
  __has_cpp_attribute(attribute)
#else
#define HEDLEY_GNUC_HAS_CPP_ATTRIBUTE(attribute, major, minor,       \
...
#endif
#if defined(__has_declspec_attribute)
#define HEDLEY_GNUC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor,  \
                                           patch)                    \
  __has_declspec_attribute(attribute)
#else
#define HEDLEY_GNUC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor,  \
...
#endif
#if defined(__has_declspec_attribute)
#define HEDLEY_GCC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor,   \
                                          patch)                     \
  __has_declspec_attribute(attribute)
#else
#define HEDLEY_GCC_HAS_DECLSPEC_ATTRIBUTE(attribute, major, minor,   \
...
#define HEDLEY_DIAGNOSTIC_DISABLE_DEPRECATED                         \
  _Pragma(                                                           \
      "error_messages(off,E_DEPRECATED_ATT,E_DEPRECATED_ATT_MESS)")
#elif HEDLEY_SUNPRO_VERSION_CHECK(5, 13, 0) && defined(__cplusplus)
#define HEDLEY_DIAGNOSTIC_DISABLE_DEPRECATED                         \
...
#define HEDLEY_DEPRECATED_FOR(since, replacement)                    \
  __attribute__((                                                    \
      __deprecated__("Since " #since "; use " #replacement)))
#elif HEDLEY_HAS_ATTRIBUTE(deprecated) ||                            \
...
#endif
#if HEDLEY_HAS_ATTRIBUTE(warning) ||                                 \
    HEDLEY_GCC_VERSION_CHECK(4, 3, 0) ||                             \
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0)
#define HEDLEY_UNAVAILABLE(available_since)                          \
  __attribute__((                                                    \
      __warning__("Not available until " #available_since)))
#else
#define HEDLEY_UNAVAILABLE(available_since)
#endif
...
#elif HEDLEY_HAS_ATTRIBUTE(noreturn) ||                              \
...
#if HEDLEY_HAS_WARNING("-Wvariadic-macros") ||                       \
    HEDLEY_GCC_VERSION_CHECK(4, 0, 0)
#if defined(__clang__)
...
#endif
#if HEDLEY_HAS_ATTRIBUTE(nonnull) ||                                 \
...
#undef HEDLEY_PRINTF_FORMAT
    ...
    HEDLEY_GCC_HAS_ATTRIBUTE(format, 4, 4, 0) &&                     \
...
#elif HEDLEY_HAS_ATTRIBUTE(format) ||                                \
    HEDLEY_GCC_VERSION_CHECK(3, 1, 0) ||                             \
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) ||                          \
    HEDLEY_ARM_VERSION_CHECK(5, 6, 0) ||                             \
    HEDLEY_IBM_VERSION_CHECK(10, 1, 0) ||                            \
...
#undef HEDLEY_MALLOC
#endif
#if HEDLEY_HAS_ATTRIBUTE(malloc) ||                                  \
    HEDLEY_GCC_VERSION_CHECK(3, 1, 0) ||                             \
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) ||                          \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) ||                         \
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) ||                             \
...
#define HEDLEY_RESTRICT restrict
    ...
    HEDLEY_PGI_VERSION_CHECK(17, 10, 0) ||                           \
    HEDLEY_TI_VERSION_CHECK(8, 0, 0) ||                              \
    (HEDLEY_SUNPRO_VERSION_CHECK(5, 14, 0) &&                        \
     defined(__cplusplus)) ||                                        \
...
#define HEDLEY_ALWAYS_INLINE                                         \
  __attribute__((__always_inline__)) HEDLEY_INLINE
#elif HEDLEY_MSVC_VERSION_CHECK(12, 0, 0)
...
#else
#if HEDLEY_HAS_ATTRIBUTE(visibility) ||                              \
    HEDLEY_GCC_VERSION_CHECK(3, 3, 0) ||                             \
    HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) ||                         \
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) ||                          \
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) ||                             \
...
#endif
#if HEDLEY_HAS_ATTRIBUTE(nothrow) ||                                 \
    HEDLEY_GCC_VERSION_CHECK(3, 3, 0) ||                             \
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0)
...
#define HEDLEY_FALL_THROUGH [[fallthrough]]
    ...
    HEDLEY_HAS_CPP_ATTRIBUTE(clang::fallthrough)
...
#include <stdint.h>
#define HEDLEY__IS_CONSTEXPR(expr)                                   \
  _Generic((1 ? (void *)((intptr_t)*0) : (int *)0), int * : 1,       \
           void * : 0)
#endif
#elif defined(HEDLEY_GCC_VERSION) ||                                 \
    defined(HEDLEY_INTEL_VERSION) ||                                 \
...
#endif
#define HEDLEY_CLANG_HAS_ATTRIBUTE(attribute)                        \
...
#endif
#define HEDLEY_CLANG_HAS_EXTENSION(extension)                        \
