...
inline parser::stack_symbol_type::stack_symbol_type(state_type s,
                                                    symbol_type &that)
...
inline parser::stack_symbol_type &
...
inline void parser::yy_destroy_(const char *yymsg,
...
inline parser::state_type parser::yy_lr_goto_state_(state_type yystate,
                                                    int yysym) {
...
#line 513 "./build/VCDParser.cpp" // lalr1.cc:741
  ...
  yyreduce:
    yylen = yyr2_[yyn];
    {
      ...
      try {
        switch (yyn) {
        case 10:
#line 111 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          driver.fh->comment = yystack_[1].value.as<std::string>();
        }
#line 670 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 11:
#line 114 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          driver.fh->date = yystack_[1].value.as<std::string>();
        }
#line 678 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 13:
#line 118 "./src/VCDParser.ypp" // lalr1.cc:859
        {
...
#line 699 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 14:
#line 134 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          driver.fh->time_resolution = yystack_[2].value.as<VCDTimeRes>();
          driver.fh->time_units = yystack_[1].value.as<VCDTimeUnit>();
        }
#line 708 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 15:
#line 138 "./src/VCDParser.ypp" // lalr1.cc:859
        {
...
#line 719 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 16:
#line 145 "./src/VCDParser.ypp" // lalr1.cc:859
        {
...
#line 742 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 17:
#line 163 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          driver.fh->version = yystack_[1].value.as<std::string>();
        }
#line 750 "./build/VCDParser.cpp" // lalr1.cc:859
        break;
...
#line 762 "./build/VCDParser.cpp" // lalr1.cc:859
        ...
        case 35:
#line 202 "./src/VCDParser.ypp" // lalr1.cc:859
        {
...
#line 780 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 36:
#line 218 "./src/VCDParser.ypp" // lalr1.cc:859
        {
...
#line 822 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 37:
#line 255 "./src/VCDParser.ypp" // lalr1.cc:859
        {
...
#line 848 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 38:
#line 278 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<VCDSignal *>() = new VCDSignal();
          yylhs.value.as<VCDSignal *>()->reference =
              yystack_[0].value.as<std::string>();
          yylhs.value.as<VCDSignal *>()->lindex = -1;
          yylhs.value.as<VCDSignal *>()->rindex = -1;
        }
#line 859 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 39:
#line 284 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<VCDSignal *>() = new VCDSignal();
          yylhs.value.as<VCDSignal *>()->reference =
...
#line 870 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 40:
#line 291 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<VCDSignal *>() = new VCDSignal();
          yylhs.value.as<VCDSignal *>()->reference =
...
#line 881 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 41:
#line 299 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<std::string>() = std::string();
        }
#line 889 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 42:
#line 302 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<std::string>() =
              std::string(yystack_[0].value.as<std::string>());
        }
#line 897 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 43:
#line 307 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<std::string>() = std::string();
        }
#line 905 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 44:
#line 310 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<std::string>() =
              std::string(yystack_[0].value.as<std::string>());
        }
#line 913 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 45:
#line 316 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<std::string>() = std::string();
        }
#line 921 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

        case 46:
#line 319 "./src/VCDParser.ypp" // lalr1.cc:859
        {
          yylhs.value.as<std::string>() =
              std::string(yystack_[0].value.as<std::string>());
        }
#line 929 "./build/VCDParser.cpp" // lalr1.cc:859
        break;

#line 933 "./build/VCDParser.cpp" // lalr1.cc:859
        default:
          break;
        }
      } catch (const syntax_error &yyexc) {
...
std::string parser::yysyntax_error_(state_type yystate,
...
const signed char parser::yypact_[] = {
    49,  43,  -9,  2,   -10, -8,  18,  9,   8,   -11, -11, -11, -11, -6,
    4,   13,  17,  42,  49,  66,  -19, -19, -19, -19, -19, -19, -19, -4,
    -19, 36,  -19, 53,  -19, -19, -19, -19, -19, -19, 30,  44,  -19, 34,
    -19, 70,  1,   5,   16,  23,  -19, -19, -19, -19, -19, 66,  -19, -11,
    -19, -19, -19, -19, -19, 72,  76,  52,  -19, -19, -19, -19, -19, -19,
    -19, 54,  87,  85,  55,  -19, 6,   -19, 56,  91,  -19};

const unsigned char parser::yydefact_[] = {
    2,  41, 45, 0,  0,  0,  0,  0,  43, 0,  0, 0,  0, 0,  0,  0,  0,
    0,  5,  4,  6,  8,  23, 24, 33, 34, 42, 0, 31, 0, 46, 0,  12, 25,
    26, 27, 28, 29, 0,  0,  15, 0,  44, 0,  0, 0,  0, 0,  30, 35, 36,
    37, 1,  3,  7,  0,  9,  22, 32, 10, 11, 0, 0,  0, 17, 18, 19, 20,
    21, 13, 14, 0,  38, 0,  0,  16, 0,  39, 0, 0,  40};

const signed char parser::yypgoto_[] = {-19, -19, -19, 78,  82,  -18, -19, -19,
                                        -5,  0,   -19, -19, -19, -19, -19, -19};

const signed char parser::yydefgoto_[] = {-1, 17, 18, 19, 20, 21, 38, 22,
                                          27, 28, 24, 25, 73, 29, 43, 31};

const unsigned char parser::yytable_[] = {
    23, 56, 30, 57, 44, 45, 46, 47, 65, 32, 77, 78, 66, 33, 34, 35, 36,
    37, 23, 23, 39, 14, 15, 67, 16, 40, 42, 58, 14, 15, 68, 16, 48, 14,
    15, 56, 16, 14, 15, 41, 16, 49, 52, 59, 58, 58, 58, 58, 14, 15, 50,
    16, 26, 23, 51, 14, 15, 1,  16, 2,  60, 3,  4,  5,  6,  7,  8,  61,
    9,  10, 11, 12, 63, 62, 55, 14, 15, 64, 16, 69, 13, 14, 15, 70, 16,
    9,  10, 11, 12, 71, 74, 72, 75, 76, 79, 80, 53, 13, 14, 15, 54, 16};

const unsigned char parser::yycheck_[] = {
    0,  19, 11, 7,  9,  10, 11, 12, 7,  7,  4,  5,  7,  23, 24, 25, 26,
    27, 18, 19, 28, 32, 33, 7,  35, 7,  18, 27, 32, 33, 7,  35, 38, 32,
    33, 53, 35, 32, 33, 30, 35, 37, 0,  7,  44, 45, 46, 47, 32, 33, 37,
    35, 9,  53, 37, 32, 33, 8,  35, 10, 7,  12, 13, 14, 15, 16, 17, 37,
    19, 20, 21, 22, 38, 29, 8,  32, 33, 7,  35, 7,  31, 32, 33, 7,  35,
    19, 20, 21, 22, 37, 3,  37, 7,  38, 38, 4,  18, 31, 32, 33, 18, 35};

const unsigned char parser::yystos_[] = {
    0,  8,  10, 12, 13, 14, 15, 16, 17, 19, 20, 21, 22, 31, 32, 33, 35,
    40, 41, 42, 43, 44, 46, 48, 49, 50, 9,  47, 48, 52, 11, 54, 7,  23,
    24, 25, 26, 27, 45, 28, 7,  30, 18, 53, 47, 47, 47, 47, 38, 37, 37,
    37, 0,  42, 43, 8,  44, 7,  48, 7,  7,  37, 29, 38, 7,  7,  7,  7,
    7,  7,  7,  37, 37, 51, 3,  7,  38, 4,  5,  38, 4};

const unsigned char parser::yyr1_[] = {
    0,  39, 40, 40, 40, 40, 41, 41, 42, 42, 43, 43, 43, 43, 43, 43,
    43, 43, 44, 44, 44, 44, 44, 44, 44, 45, 45, 45, 45, 45, 46, 47,
    47, 48, 48, 49, 50, 50, 51, 51, 51, 52, 52, 53, 53, 54, 54};

const unsigned char parser::yyr2_[] = {
    0, 2, 0, 2, 1, 1, 1, 2, 1, 2, 3, 3, 2, 4, 4, 2, 6, 3, 3, 3, 3, 3, 3, 1,
    1, 1, 1, 1, 1, 1, 2, 1, 2, 1, 1, 2, 2, 2, 1, 4, 6, 0, 1, 0, 1, 0, 1};
...
const unsigned short int parser::yyrline_[] = {
    0,   94,  94,  95,  96,  97,  101, 102, 106, 107, 111, 114,
    117, 118, 134, 138, 144, 163, 169, 170, 171, 172, 173, 174,
    175, 179, 180, 181, 182, 183, 186, 195, 196, 199, 200, 202,
    218, 255, 278, 284, 290, 299, 302, 307, 310, 316, 319};
...
#line 1367 "./build/VCDParser.cpp" // lalr1.cc:1167
#line 323 "./src/VCDParser.ypp"    // lalr1.cc:1168
