...
#line 54 "./build/VCDParser.hpp" // lalr1.cc:377
...
namespace VCDParser {
#line 131 "./build/VCDParser.hpp" // lalr1.cc:377
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 51: // reference
        value.copy< VCDSignal* > (other.value);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const VCDSignal* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
...
#line 1557 "./build/VCDParser.hpp" // lalr1.cc:377
