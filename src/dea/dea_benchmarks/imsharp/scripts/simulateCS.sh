...
$MODELSIM_BIN/vlog -work "work$threadID" +define+TRACE_LENGTH=""$traceLength"" +define+OUT_PATH=""$work"/" $compDefine -sv "$BENCHMARK_ROOT/imsharp/rtl/cs/*" "$BENCHMARK_ROOT/imsharp/rtl/tb/*"
