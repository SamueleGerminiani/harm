...
public:
  ...
  virtual void
  enterLogicAtom(metricParser::LogicAtomContext * /*ctx*/) override {}
  virtual void
  exitLogicAtom(metricParser::LogicAtomContext * /*ctx*/) override {}

  virtual void
  enterLogicConstant(metricParser::LogicConstantContext * /*ctx*/) override {}
  virtual void
  exitLogicConstant(metricParser::LogicConstantContext * /*ctx*/) override {}

  virtual void
  enterLogicVariable(metricParser::LogicVariableContext * /*ctx*/) override {}
  virtual void
  exitLogicVariable(metricParser::LogicVariableContext * /*ctx*/) override {}
  ...
  virtual void
  enterNumericAtom(metricParser::NumericAtomContext * /*ctx*/) override {}
  virtual void
  exitNumericAtom(metricParser::NumericAtomContext * /*ctx*/) override {}

  virtual void enterNumericConstant(
      metricParser::NumericConstantContext * /*ctx*/) override {}
  virtual void
  exitNumericConstant(metricParser::NumericConstantContext * /*ctx*/) override {
  }

  virtual void enterNumericVariable(
      metricParser::NumericVariableContext * /*ctx*/) override {}
  virtual void
  exitNumericVariable(metricParser::NumericVariableContext * /*ctx*/) override {
  }
