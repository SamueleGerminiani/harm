...
sere : boolean | (NOT)? PLACEHOLDER | (NOT)? FUNCTION LROUND nonTemporalExp RROUND
	 ...
	 | sere LSQUARED TIMES UINTEGER? DOTS? (UINTEGER | DOLLAR)? RSQUARED
	 | sere LSQUARED ASS UINTEGER DOTS? (UINTEGER | DOLLAR)? RSQUARED
	 | sere LSQUARED IMPL UINTEGER DOTS? (UINTEGER | DOLLAR)? RSQUARED
	 | sere DELAY LSQUARED? UINTEGER? DOTS? (UINTEGER | DOLLAR)? RSQUARED? sere
