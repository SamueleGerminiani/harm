...
public:
  ...
  virtual void
  enterBooleanConstant(temporalSVAParser::BooleanConstantContext *ctx) = 0;
  virtual void
  exitBooleanConstant(temporalSVAParser::BooleanConstantContext *ctx) = 0;

  virtual void
  enterBooleanVariable(temporalSVAParser::BooleanVariableContext *ctx) = 0;
  virtual void
  exitBooleanVariable(temporalSVAParser::BooleanVariableContext *ctx) = 0;
  ...
  virtual void
  enterLogicConstant(temporalSVAParser::LogicConstantContext *ctx) = 0;
  virtual void
  exitLogicConstant(temporalSVAParser::LogicConstantContext *ctx) = 0;

  virtual void
  enterLogicVariable(temporalSVAParser::LogicVariableContext *ctx) = 0;
  virtual void
  exitLogicVariable(temporalSVAParser::LogicVariableContext *ctx) = 0;
  ...
  virtual void
  enterNumericConstant(temporalSVAParser::NumericConstantContext *ctx) = 0;
  virtual void
  exitNumericConstant(temporalSVAParser::NumericConstantContext *ctx) = 0;

  virtual void
  enterNumericVariable(temporalSVAParser::NumericVariableContext *ctx) = 0;
  virtual void
  exitNumericVariable(temporalSVAParser::NumericVariableContext *ctx) = 0;
