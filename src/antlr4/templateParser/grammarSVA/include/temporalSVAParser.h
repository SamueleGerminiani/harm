...
public:
  ...
  enum {
    ...
    RuleBoolean = 8,
    RuleBooleanAtom = 9,
    RuleBooleanConstant = 10,
    RuleBooleanVariable = 11,
    RuleLogic = 12,
    RuleLogicAtom = 13,
    RuleLogicConstant = 14,
    RuleLogicVariable = 15,
    RuleNumeric = 16,
    RuleNumericAtom = 17,
    RuleNumericConstant = 18,
    RuleNumericVariable = 19,
    RuleVariable = 20,
    RuleRelop = 21
  };
  ...
  public:
    BooleanConstantContext(antlr4::ParserRuleContext *parent,
  ...
  public:
    BooleanVariableContext(antlr4::ParserRuleContext *parent,
                           size_t invokingState);
    virtual size_t getRuleIndex() const override;
