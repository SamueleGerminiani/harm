...
struct TemporalSVALexerStaticData final {
  ...
  TemporalSVALexerStaticData &
  operator=(const TemporalSVALexerStaticData &) = delete;
...
temporalSVALexer::temporalSVALexer(CharStream *input) : Lexer(input) {
  ...
  _interpreter = new atn::LexerATNSimulator(
      this, *temporalsvalexerLexerStaticData->atn,
      temporalsvalexerLexerStaticData->decisionToDFA,
      temporalsvalexerLexerStaticData->sharedContextCache);
}

temporalSVALexer::~temporalSVALexer() { delete _interpreter; }

std::string temporalSVALexer::getGrammarFileName() const { return "sva.g4"; }
...
void temporalSVALexer::initialize() {
  std::call_once(temporalsvalexerLexerOnceFlag,
                 temporalsvalexerLexerInitialize);
}
