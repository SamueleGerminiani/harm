...
public:
  ...
  virtual void
  enterBooleanConstant(propositionParser::BooleanConstantContext *ctx) = 0;
  virtual void
  exitBooleanConstant(propositionParser::BooleanConstantContext *ctx) = 0;

  virtual void
  enterBooleanVariable(propositionParser::BooleanVariableContext *ctx) = 0;
  virtual void
  exitBooleanVariable(propositionParser::BooleanVariableContext *ctx) = 0;
  ...
  virtual void
  enterLogicConstant(propositionParser::LogicConstantContext *ctx) = 0;
  virtual void
  exitLogicConstant(propositionParser::LogicConstantContext *ctx) = 0;

  virtual void
  enterLogicVariable(propositionParser::LogicVariableContext *ctx) = 0;
  virtual void
  exitLogicVariable(propositionParser::LogicVariableContext *ctx) = 0;
  ...
  virtual void
  enterNumericConstant(propositionParser::NumericConstantContext *ctx) = 0;
  virtual void
  exitNumericConstant(propositionParser::NumericConstantContext *ctx) = 0;

  virtual void
  enterNumericVariable(propositionParser::NumericVariableContext *ctx) = 0;
  virtual void
  exitNumericVariable(propositionParser::NumericVariableContext *ctx) = 0;
