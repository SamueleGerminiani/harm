...
public:
  ...
  virtual void
  exitVarDec(varDeclarationParser::VarDecContext * /*ctx*/) override {}
  ...
  virtual void
  enterVartype(varDeclarationParser::VartypeContext * /*ctx*/) override {}
  virtual void
  exitVartype(varDeclarationParser::VartypeContext * /*ctx*/) override {}
