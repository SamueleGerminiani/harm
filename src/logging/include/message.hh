...
/// @param message is the actual message to print.
void _harm_internal_messageWarning(const std::string &file, unsigned int line,
...
/// @param line is expanded by macro to the raising point of the message.
/// @param message is the actual message to print.
void _harm_internal_messageError(const std::string &file, unsigned int line,
                                 const std::string &message);

#define messageInfo(message) hlog::_harm_internal_messageInfo((message))
